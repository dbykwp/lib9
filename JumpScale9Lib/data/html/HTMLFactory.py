...
class HTMLFactory(JSBASE):
    ...
    def webparts_enable(self,url=""):
        """
        will load webparts from https://github.com/Jumpscale/jumpscale_weblibs/tree/master/webparts if not url defined

        each webpart is an add function to manipulate the html page object

        """
        if not url:
            url = "https://github.com/Jumpscale/jumpscale_weblibs/tree/master/webparts"
