...
import os
from flask import current_app, Blueprint, send_from_directory, render_template, request, session, abort, redirect
...
def stats():
    dashboard = current_app.config['grafana_dashboard_info']
